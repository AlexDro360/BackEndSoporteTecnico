    ...
    public function index(Request $request)
    {
        ...
        return response()->json([
            ...
            "roles" => $roles->map(function($rol){
                ...
                $rol->create_format_at = $rol->created_at->format("Y-m-d h:i A");
                return $rol;
            })
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            ...
            "role" => [
                ...
                "create_format_at" => $role->created_at->format("Y-m-d h:i A"),
                "name" => $role->name,
            ]
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return response()->json([
            ...
            "role" => [
                "id" => $role->id,
                "permission" => $role->permissions,
                "permission_pluck" => $role->permissions->pluck("names"),
                "create_format_at" => $role->created_at->format("Y-m-d h:i A"),
                "name" => $role->name,
            ]
        ]);
